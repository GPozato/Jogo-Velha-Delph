...
procedure TfrmJogoVelha.btnLimparClick(Sender: TObject);
begin
...
begin
   ...
   begin
      Application.MessageBox('Jogador O Vencer!','Campeão', MB_OK + MB_ICONINFORMATION);
      cont :=0;
   end
   ...
   begin
       Application.MessageBox('Jogador X Vencer!','Campeão', MB_OK + MB_ICONINFORMATION);
       cont := 0;
   end
   else if cont = 9 then
   begin
      Application.MessageBox('Boora BILLL','Empatou', MB_OK + MB_ICONINFORMATION);
      cont := 0;
   end;
